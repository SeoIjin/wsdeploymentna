...
<body>
  ...
  <div class="filters-header">
    <div class="filter-tabs">
      ...
      <button class="filter-tab" data-filter="STATUS_CHANGE,REQUEST_UPDATE,REQUEST_DELETE">
    ...
    <!-- Audit List (includes pagination to keep the bottom border merged) -->
    <div class="audit-list">
      ...
      <!-- Pagination (moved inside audit-list so rounded corners/border merge) -->
