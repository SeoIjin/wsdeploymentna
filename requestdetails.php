    ...
    <style>
        * {
        ...
        .header-left {
            display: flex;
            align-items: center;
            gap: 0; /* keep back button tight to logo/title */
        }
        ...
        .back-btn {
            ...
            margin-right: 12px; /* spacing before logo/title */
        }
        ...
        .back-btn i {
            color: #374151; /* ensure icon color matches trackreq.php */
        }
        ...
        @media (max-width: 1024px) {
            ...
            /* keep header left-aligned on tablet and mobile */
            header {
                        ...
                        <div class="info-item">
                            ...
                            <p class="info-value">
                                ...
                                <span class="verified-badge">
                                    Verified User <i class="fas fa-check-circle"></i>
                                </span>
                            </p>
                        </div>
